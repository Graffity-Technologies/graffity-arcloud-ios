...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            ...
            url: "https://graffity-sdk-public.s3.ap-southeast-1.amazonaws.com/iOS/GraffityARCloud-5.1.1.xcframework.zip",
            checksum: "1944df454c42abbed7ccd74a5b3554169ae28b768fba700eb761939c4820d8b0"
        ),
        .target(
            name: "GraffityARCloud",
            dependencies: [
