...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "GraffityARCloud",
            url: "https://graffity-sdk-public.s3.ap-southeast-1.amazonaws.com/iOS/GraffityARCloud-0.4.5.xcframework.zip",
            checksum: "e72fc97d0ca04b7a991a4af57d648cfe1d25a4caa6f26790426cac1a66427668"
        )
    ]
)
