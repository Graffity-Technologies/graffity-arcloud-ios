...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "GraffityARCloud",
            url: "https://graffity-sdk-public.s3.ap-southeast-1.amazonaws.com/iOS/GraffityARCloud-0.8.2.xcframework.zip",
            checksum: "c7d557f1b306dac56cfa120423bf21dc4f63cf217dd53bf9717ad12a786a6bfe"
        )
    ]
)
