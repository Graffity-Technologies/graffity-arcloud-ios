...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            ...
            url: "https://graffity-sdk-public.s3.ap-southeast-1.amazonaws.com/iOS/GraffityARCloud-5.1.0.xcframework.zip",
            checksum: "586df27a8698365a472786d369bfdfdf78365ae9e45e7522c8c3a7d0a541f0ed"
        ),
        .target(
            name: "GraffityARCloud",
            dependencies: [
