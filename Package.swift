...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "GraffityARCloud",
            url: "https://graffity-sdk-public.s3.ap-southeast-1.amazonaws.com/iOS/GraffityARCloud-0.4.6.xcframework.zip",
            checksum: "8f2986ed3d0b7644a8c6271bc6fab10def720d7b147a534e626f8b7d860de2c4"
        )
    ]
)
