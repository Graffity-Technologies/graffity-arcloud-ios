...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "GraffityARCloud",
            url: "https://graffity-sdk-public.s3.ap-southeast-1.amazonaws.com/iOS/GraffityARCloud-0.4.0.xcframework.zip",
            checksum: "005204cf49b6049b868bef7ce384b85d4335dea5be36f68c8385d79c94065597"
        )
    ]
)
