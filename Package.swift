...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "GraffityARCloud",
            url: "https://graffity-sdk-public.s3.ap-southeast-1.amazonaws.com/iOS/GraffityARCloud-0.5.2.xcframework.zip",
            checksum: "7543b2fcb610f881a4babe72fe912086f8a4417b43e2a3c744cc65246a0abe4f"
        )
    ]
)
